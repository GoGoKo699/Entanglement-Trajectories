...
REQUIRED = [
    ...
    "CORRECTIONS.md",
    "docs/RELEASE_QA.md",
    "docs/NUMERICAL_FOUNDATIONS.md",
    "metadata/numerical_foundations_summary.json",
    "analysis/verify_numerical_foundations.py",
    "tests/test_numerical_foundations.py",
    "LICENSE",
    "REFERENCES.md",
    "docs/CONCEPTUAL_NEIGHBORS.md",
    "LICENSE-CONTENT.md",
    "CITATION.cff",
    "codemeta.json",
    "llms.txt",
    ...
    "metadata/conceptual_neighbors.json",
