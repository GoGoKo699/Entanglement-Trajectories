...
2. `metadata/release_manifest.json` and `SHA256SUMS.txt` have been regenerated for the final tree;
3. the hosted `repository-qa` GitHub Actions workflow passes;
4. the repository description, DOI homepage, topics, and social preview have been applied.
